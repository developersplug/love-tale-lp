        ...
        <>
            ...
            <div className='w-full mt-20'>
                <div className='flex flex-col items-center justify-center gap-1 my-4'>
                    ...
                    <h2 className='text-[28px] font-medium'>Start your <span className='underline underline-offset-2 decoration-pink-500'>Search</span> Here</h2>
                </div>
                <div className='w-[90%] mx-auto p-2 md:flex   md:items-center md:gap-1  md:justify-center my-2 grid grid-cols-2'>
                    {
                        cardItems.map((item, idx) => (
                            <div className='md:w-[20%]  flex-1 m-1  flex flex-col items-center justify-center ' key={idx}>
